...
public class RedactUserCommand implements ActionCommand {

    private UsersDAO usersDAO;
    private DAOFactory daoFactory;
    
    public RedactUserCommand(DAOFactory daoFactory) {
    ...
    public String execute(HttpServletRequest request) {
        ...
        usersDAO.redactUser(name, roleName, firstName, lastName, password);
